                    ...
                    <div className="space-y-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <select required className="w-full bg-neutral-900 border border-white/20 p-4 text-sm focus:border-tiffany outline-none transition-colors appearance-none">
                          <option value="" disabled selected>{t('distributor.selectIndustry')}</option>
                      ...
                      <div className="space-y-4">
                        ...
                        <select required className="w-full bg-neutral-900 border border-white/20 p-4 text-sm focus:border-tiffany outline-none transition-colors appearance-none">
                          <option value="" disabled selected>{t('form.selectOption')}</option>
                      ...
                      <div className="space-y-4">
                        ...
                        <select required className="w-full bg-neutral-900 border border-white/20 p-4 text-sm focus:border-tiffany outline-none transition-colors appearance-none">
                          <option value="" disabled selected>{t('distributor.selectRegion')}</option>
                      ...
                      <div className="space-y-4">
                        ...
                        <select required className="w-full bg-neutral-900 border border-white/20 p-4 text-sm focus:border-tiffany outline-none transition-colors appearance-none">
                          <option value="" disabled selected>{t('distributor.selectExperience')}</option>
